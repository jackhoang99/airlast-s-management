  ...
  useEffect(() => {
    ...
    if (filters.serviceLine !== "all") {
      result = result.filter(
        (item) => item.service_line === filters.serviceLine
      );
    }
                ...
                {filteredItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm font-medium">
                        {Number(item.estimated_hours).toFixed(1)}
                      </td>
                      <td className="px-4 py-3 text-sm font-medium">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewItem((prev) => ({
                      ...prev,
                      flat_rate_non_contract: e.target.value,
                    }))
                  }
                  className="input"
                  required
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewItem((prev) => ({
                      ...prev,
                      flat_rate_pm_contract: e.target.value,
                    }))
                  }
                  className="input"
                  required
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-center text-gray-600 mb-6">
              ...
              <strong>{selectedItem.name}</strong> ({selectedItem.code})? This
