    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (locationIds.length > 0) {
          ...
          const { data: upcomingJobsData, error: upcomingJobsError } = await supabase
            .from('jobs')
            .select(`
              *,
              locations (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="card">
          ...
          <div className="mt-4">
            <Link to="/customer/locations" className="text-sm text-primary-600 hover:text-primary-800">
              View all locations →
            </Link>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="mt-4">
            <Link to="/customer/jobs" className="text-sm text-primary-600 hover:text-primary-800">
              View all jobs →
            </Link>
          </div>
        </div>
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-semibold mt-1">{stats.pendingInvoices}</p>
            </div>
          ...
          <div className="mt-4">
            <Link to="/customer/invoices" className="text-sm text-primary-600 hover:text-primary-800">
              View all invoices →
            </Link>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="mt-4">
            <Link to="/customer/jobs?status=completed" className="text-sm text-primary-600 hover:text-primary-800">
              View completed jobs →
            </Link>
          </div>
        </div>
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          <div className="flex items-start">
            ...
            <p className="text-blue-700">
              Regular maintenance of your HVAC system can extend its lifespan by up to 5 years and reduce energy costs by up to 15%. 
              Schedule preventative maintenance twice a year - once before summer and once before winter - to ensure optimal performance.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/customer/jobs" className="text-sm text-primary-600 hover:text-primary-800 flex items-center">
        ...
        <div className="card">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/customer/invoices" className="text-sm text-primary-600 hover:text-primary-800 flex items-center">
              View All <ArrowRight size={16} className="ml-1" />
            </Link>
          </div>
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {invoice.jobs?.name}
                        {invoice.jobs?.locations ? ` • ${invoice.jobs.locations.name}` : ''}
                      </p>
                    </div>
                    <div className="text-right">
