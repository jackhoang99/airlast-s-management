        ...
        if (approved !== null) {
          ...
          if (approved === false && supabase && jobDetails) {
            ...
            try {
              ...
              console.log('Invoice created and email sent successfully');
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full">
          ...
          <p className="text-gray-600 text-center mb-6">
            {approved 
              ...
              : 'You have declined the repairs. An invoice for the inspection fee ($180.00) has been sent to your email.'}
          </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-error-600">
                        Since you've declined the repairs, an invoice for the inspection fee ($180.00) has been {invoiceCreated ? 'sent to your email' : 'generated'}.
                      </p>
                    </div>
                  </div>
                </div>
