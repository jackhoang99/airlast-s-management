...
const DispatchSchedule = () => {
  ...
  const [technicianJobs, setTechnicianJobs] = useState<{
    [key: string]: Date[];
  }>({}); // Store dates with jobs for each technician
  ...
  useEffect(() => {
    ...
    const fetchJobs = async () => {
      ...
      try {
        ...
        const completed = jobsWithCoordinates.filter(
          (job) => job.status === "completed"
        );
        const active = jobsWithCoordinates.filter(
          (job) => job.status !== "completed"
        );
        ...
        active.forEach((job) => {
          ...
          if (job.job_technicians && job.job_technicians.length > 0) {
            const technicianIds = job.job_technicians.map(
              (jt) => jt.technician_id
            );
        ...
        if (selectedTechnician) {
          ...
          const hasTechnician =
            ...
            job.job_technicians.some(
              (jt) => jt.technician_id === selectedTechnician
            );
              ...
              <p style="margin: 4px 0; font-size: 12px;">
                ...
                ${
                  job.job_technicians && job.job_technicians.length > 0
                    ? `<strong>Technicians:</strong> ${job.job_technicians
                        .map(
  ...
  const getTimelinePosition = (job: Job) => {
    ...
    if (job.schedule_duration) {
      const durationMatch = job.schedule_duration
        .toString()
        .match(/(\d+):(\d+)/);
      if (durationMatch) {
        durationHours =
            ...
            <div className="space-y-2">
              {isLoading ? (
                ...
                filteredTechnicians.map((tech) => {
                  ...
                  const completedTechJobs = getCompletedJobsForTechnician(
                    tech.id
                  );
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">
                            ...
                            {showCompletedJobs &&
                              completedTechJobs.length > 0 &&
                              ` • ${completedTechJobs.length} completed`}
                          </div>
                        </div>
                      </div>
            ...
            <div className="relative min-w-[1200px]">
              ...
              <div className="flex border-b border-gray-200 bg-gray-50 sticky top-0 z-10">
                ...
                {Array.from({ length: 24 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex-1 border-r border-gray-200 p-2 text-sm text-gray-500 text-center"
                  >
                ...
                >
                  <div className="w-[200px] border-r border-gray-200 p-2 flex items-center">
                    ...
                    <div>
                      <div className="font-medium">{`${tech.first_name} ${tech.last_name}`}</div>
                      <div className="text-xs text-gray-500">
                        {tech.role === "technician" ? "technician" : tech.role}
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 relative h-16">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="truncate">
                              {job.locations?.name || "No location"}{" "}
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="absolute right-0 top-0 h-full w-96 bg-white shadow-xl">
            ...
            <div
              ...
              style={{ height: "calc(100% - 65px - 73px)" }}
            >
              {/* Tags */}
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilters((prev) => ({
                      ...prev,
                      filterDateRangeBy: e.target.value,
                    }))
                  }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    onClick={() =>
                      setFilters((prev) => ({
                        ...prev,
                        limitByPrice: !prev.limitByPrice,
                      }))
                    }
                  >
                    <span
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    onClick={() =>
                      setFilters((prev) => ({
                        ...prev,
                        showSubcontracted: !prev.showSubcontracted,
                      }))
                    }
                  >
                    <span
