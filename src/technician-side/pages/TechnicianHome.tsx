...
import { Briefcase, Calendar, MapPin, Clock, CheckSquare, AlertTriangle, ArrowRight, Navigation, Phone, Mail, Settings, Thermometer, Wind, Wrench, FileText } from 'lucide-react';
            ...
            if (data) {
              ...
              if (usernameData) {
                ...
                if (usernameData.role !== 'technician') {
                  console.warn("User found but not a technician:", usernameData);
                  setError('This account does not have technician access');
                }
              } else {
  ...
  return (
    <div className="space-y-6 pb-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold mb-2">Welcome, {technicianName || technicianUsername || 'Technician'}</h1>
            ...
            <div>
              ...
              <div className="flex items-center mt-1">
                ...
                <div className="ml-2 text-sm">
                  ...
                  <div>H: {weatherData.highTemp}° L: {weatherData.lowTemp}°</div>
                </div>
              </div>
            </div>
            <div className="text-right">
              <div className="text-lg">{weatherData.condition}</div>
              <div className="text-sm mt-1">Humidity: {weatherData.humidity}%</div>
        ...
        <>
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="p-4 bg-primary-50 border-b border-primary-100 flex justify-between items-center">
              ...
              <Link to="/tech/schedule" className="text-primary-600 text-sm flex items-center">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <div className="flex items-center text-sm font-medium text-primary-600">
                          ...
                          {job.schedule_start ? formatTime(job.schedule_start) : 'Unscheduled'}
                        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link to="/tech/map" className="bg-white rounded-lg shadow p-4 flex flex-col items-center justify-center text-center hover:bg-gray-50">
              <MapPin size={24} className="text-primary-600 mb-2" />
              <span className="font-medium">View Map</span>
              <span className="text-xs text-gray-500 mt-1">Navigate to jobs</span>
            </Link>
            
            <Link to="/tech/schedule" className="bg-white rounded-lg shadow p-4 flex flex-col items-center justify-center text-center hover:bg-gray-50">
              <Calendar size={24} className="text-primary-600 mb-2" />
              <span className="font-medium">Schedule</span>
              <span className="text-xs text-gray-500 mt-1">View your calendar</span>
            </Link>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-3 bg-gray-50 rounded-lg flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Pressure-temperature charts</p>
                </div>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg flex items-center">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <div className="text-sm font-medium text-gray-900">
                          {job.schedule_start ? formatDate(job.schedule_start) : 'Unscheduled'}
                        </div>
                        <div className="text-xs text-gray-500">
                          {job.schedule_start ? formatTime(job.schedule_start) : ''}
                        </div>
                      </div>
                    </div>
                  </Link>
