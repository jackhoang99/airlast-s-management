  ...
  useEffect(() => {
    ...
    const fetchLocationDetails = async () => {
      ...
      try {
        ...
        if (!locationData) {
          throw new Error(
            "Location not found or you do not have access to this location"
          );
        }
        ...
        setError(
          err instanceof Error ? err.message : "Failed to load location details"
        );
      } finally {
        setIsLoading(false);
      }
        ...
        {recentJobs.length === 0 ? (
          <div className="text-center py-8 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-500">
              No service history found for this location
            </p>
          </div>
        ) : (
