...
interface CustomerInspectionAttachmentPreviewProps {
  inspectionId: string;
  onAttachmentClick?: () => void;
  refreshTrigger?: number;
}

const CustomerInspectionAttachmentPreview: React.FC<
  CustomerInspectionAttachmentPreviewProps
  ...
  if (attachments.length === 0) {
    return (
      <div className="text-sm text-gray-500 italic">
        No attachments found for this inspection.
      </div>
    );
  }
...
export default CustomerInspectionAttachmentPreview;
