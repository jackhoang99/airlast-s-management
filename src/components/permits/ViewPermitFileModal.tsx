...
interface ViewPermitFileModalProps {
  isOpen: boolean;
  onClose: () => void;
  filePath: string;
  fileName: string;
...
const ViewPermitFileModal: React.FC<ViewPermitFileModalProps> = ({
  isOpen,
  onClose,
  filePath,
  fileName,
  ...
  if (!filePath || !fileName || !fileType) {
    console.error("Missing required props:", { filePath, fileName, fileType });
    return null;
  }
  ...
  try {
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  ...
                  {fileType.includes("image") && zoom > 1 && (
    ...
    console.error("Error rendering ViewPermitFileModal:", error);
    return (
...
export default ViewPermitFileModal;
