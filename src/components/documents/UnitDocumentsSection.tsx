...
const UnitDocumentsSection: React.FC<UnitDocumentsSectionProps> = ({
  unitId,
  locationId,
  companyId,
  ...
  const [selectedDocument, setSelectedDocument] = useState<UnitDocument | null>(
    null
  );
  ...
  const handleEditDocument = (document: UnitDocument) => {
    setSelectedDocument(document);
    setShowEditModal(true);
  };

  const handleViewDocument = (document: UnitDocument) => {
    setSelectedDocument(document);
      ...
      {documents.length === 0 ? (
        <div className="text-center py-4">
          ...
          <p className="text-gray-500 mb-3 text-sm">
            Get started by adding your first document for this unit
          </p>
          <button
...
export default UnitDocumentsSection;
