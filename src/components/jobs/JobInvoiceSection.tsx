...
const JobInvoiceSection = ({
  ...
  const [invoiceType, setInvoiceType] = useState<
    "standard" | "inspection" | "repair" | "replacement"
  >("standard");
  const [repairData, setRepairData] = useState<any>(null);
  const [repairDataByInspection, setRepairDataByInspection] = useState<{
    [key: string]: any;
  }>({});
  ...
  const calculateTotalCost = () => {
    ...
    if (invoiceType === "standard") {
      ...
      const inspectionFee = inspectionItem
        ? Number(inspectionItem.total_cost)
        : 0;
      ...
      if (
        otherItemsTotal === 0 &&
        Object.values(repairDataByInspection).length > 0
      ) {
    ...
    if (invoiceType === "inspection") {
      const inspectionItem = jobItems.find((item) => item.code === "INSP-FEE");
      return inspectionItem ? Number(inspectionItem.total_cost) : 180.0;
    }
  ...
  const handleCreateInvoice = async () => {
    ...
    try {
      ...
      if (invoiceType === "inspection") {
        invoiceAmount = 180.0; // Fixed inspection fee
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedInvoice.issued_date || "Not issued"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="mt-2 text-sm">
                    ...
                    {(() => {
                      ...
                      if (
                        ...
                        // Sum up all replacement costs from all inspections
                        const replacementTotal = Object.values(
                  ...
                  <div className="mt-2 text-sm">
                    ...
                    {(() => {
                      ...
                      if (
                        ...
                        // Sum up all repair costs from all inspections
                        const repairTotal = Object.values(
                          repairDataByInspection
                        ).reduce(
                          (sum, data: any) => sum + (data.totalCost || 0),
                          0
