      ...
      try {
        ...
        if (clockData && clockData.length > 0) {
          ...
          clockData.forEach((event, index) => {
            ...
            if (event.event_type === 'clock_in') {
            ...
            else if ((event.event_type === 'clock_out' || event.event_type === 'break_start') && clockInTime) {
              ...
              if (duration > 0) {
                ...
                technicianTimes[techId] = (technicianTimes[techId] || 0) + duration;
              }
          ...
          if (clockInTime) {
            ...
            if (duration > 0) {
              ...
              technicianTimes[lastEvent.user_id] = (technicianTimes[lastEvent.user_id] || 0) + duration;
            }
          }
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 text-left">
              <tr>
                <th className="px-4 py-2 text-sm font-medium text-gray-500">TECHNICIAN</th>
