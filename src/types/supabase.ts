    ...
    Tables: {
      ...
      pm_quotes: {
        Row: {
          ...
          total_cost: number;
          notes: string | null;
          comprehensive_visit_cost: number | null;
          filter_visit_cost: number | null;
          comprehensive_visit_description: string | null;
          filter_visit_description: string | null;
          unit_count: number | null;
          service_period: string | null;
          filter_visit_period: string | null;
          comprehensive_visits_count: number | null;
          filter_visits_count: number | null;
          total_comprehensive_cost: number | null;
          total_filter_cost: number | null;
          client_name: string | null;
          property_address: string | null;
          scope_of_work: string | null;
          service_breakdown: string | null;
          preventative_maintenance_services: string[] | null;
          include_comprehensive_service: boolean | null;
          include_filter_change_service: boolean | null;
          created_at: string;
          updated_at: string;
        };
        Insert: {
