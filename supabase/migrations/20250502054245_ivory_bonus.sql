/*
  ...
  2. Data Structure
    - Companies include name, city, state
    - Locations include name, address, company reference
*/

-- Insert companies first
WITH company_data AS (
  INSERT INTO companies (name, city, state, status)
  VALUES
    ('5Rivers', 'Houston', 'TX', 'Active'),
    ('Aldea Ministry', 'Greensboro', 'NC', 'Active'),
    ('Bridger Properties', 'Atlanta', 'GA', 'Active'),
    ('David Martos', 'Atlanta', 'GA', 'Active'),
    ('Faropoint', 'Hoboken', 'NJ', 'Active'),
    ('Klingon High Council', 'Burlington', 'NC', 'Active'),
    ('Net Leased Management', 'San Diego', 'CA', 'Active'),
    ('Pinnacle Leasing & Management', 'Alpharetta', 'GA', 'Active'),
    ('Quark''s Holdings LLC', 'Raleigh', 'NC', 'Active'),
    ('Risian Cultural Exchange', 'Durham', 'NC', 'Active'),
    ('The Borg Collective', 'Seattle', 'WA', 'Active')
  RETURNING id, name
)
...
LATERAL (
  VALUES 
    ...
    ('Aldea Ministry', 'The Aldean Children''s Hospital', '3403 NE 1st Ave', 'Miami', 'FL', '33137'),
