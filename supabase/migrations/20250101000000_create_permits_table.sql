...
ALTER TABLE ONLY "public"."permits"
    ADD CONSTRAINT "permits_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE SET NULL;
...
CREATE POLICY "Users can insert permits" ON "public"."permits" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "created_by"));

CREATE POLICY "Users can update permits" ON "public"."permits" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "created_by")) WITH CHECK (("auth"."uid"() = "created_by"));

CREATE POLICY "Users can delete permits" ON "public"."permits" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "created_by"));
